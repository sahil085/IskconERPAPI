package com.example.IskconErpAPI.repositoryConfig;
...
@EnableJpaRepositories("com.example.IskconErpAPI.repository")
@ComponentScan(basePackages = { "com.example.IskconErpAPI.repository"},
